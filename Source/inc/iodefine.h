...
/*     The name that can be used is a macro name defined with "rx630_iodefine.h */
/*     for example :                                                            */
...
DTCE_TPU3_TGI3A=134,DTCE_TPU3_TGI3B,DTCE_TPU3_TGI3C,DTCE_TPU3_TGI3D,
...
/*| LANコントローラ定義                                                    |*/
/*[]----------------------------------------------------------------------[]*/
#define	EXIO_CS3_ETHER_CTR	(*(volatile unsigned char *)0x3000000)	//	EthernetCTR	


/*[]----------------------------------------------------------------------[]*/
/*| シリアルポート定義                                                     |*/
/*[]----------------------------------------------------------------------[]*/
#define		P_SCI_L		SCI4			// フラップ, CRB


/****************************************************/
/*	n(SMR.CKS:2)=0(0/1/2/3=PCLK, 1/4, 1/16, 1/64)	*/
/*	SCIXX.SEMR.BIT.ABCS=1(0/1 = 16Cycle/8Cycle)		*/
/*	N(BRR)の値										*/
/*		水晶振動子	12.500MHｚ						*/
/*		PCLK		50.000MHｚ						*/
/****************************************************/
#define		SCI_1200BPS_n2		162		//	(n=2)
//#define		SCI_2400BPS_n1		352		//	(n=1)(乱数値の352がBRRに設定できない（オーバーフローする）ので、2400は廃止)
#define		SCI_4800BPS_n1		162		//	JVMA(ｺｲﾝﾒｯｸ,紙幣ﾘｰﾀﾞ):SCI2(n=1)
#define		SCI_9600BPS_n1		80		//	(n=1)
#define		SCI_19200BPS_n1		40		//	(n=1)
#define		SCI_28800BPS_n0		108		//	(n=0)
#define		SCI_38400BPS_n0		80		//	磁気Reader制御	:SCI3(n=0)
										//	Flap制御		:SCI4(n=0)
										//	serverFOMA_Rism	:SCI7(n=0)
										//	NT-NET通信		:SCI9(n=0)
										//	非接触IC		:SCI10(n=0)
										//	MultiICcardR/W	:SCI11(n=0)
#define		SCI_57600BPS_n0		53		//	(n=0)
#define		SCI_76800BPS_n0		40		//	(n=0)
#define		SCI_115200BPS_n0	26		//	Bluetooth:SCI6(n=0)
										//  
#define		SCI_153600BPS_n0	19		//	(n=0)
#define		SCI_230400BPS_n0	13		//	(n=0)
#define		SCI_312500BPS_n0	9		//	(n=0)
#define		SCI_384000BPS_n0	7		//	(n=0)
