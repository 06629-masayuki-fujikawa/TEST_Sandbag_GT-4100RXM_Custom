...
//							{ 0,	22,	1,	CCOM_SEQCLR},		// 2: センター追番クリア
...
// MH810100(E) Y.Yamauchi 2019/10/03 車番チケットレス(メンテナンス)
// GM849100(S) 名鉄協商コールセンター対応（NT-NET端末間通信）（FT-4000N：MH364304流用）
							{ 0,	26,	__ntn_check,		NTNET_CHK },		/* : ＮＴ－ＮＥＴチェック	*/
// GM849100(E) 名鉄協商コールセンター対応（NT-NET端末間通信）（FT-4000N：MH364304流用）
...
// MH810100(E) Y.Yamauchi 2019/10/03 車番チケットレス(メンテナンス)
// GM849100(S) 名鉄協商コールセンター対応（NT-NET端末間通信）（FT-4000N：MH364304流用）
							{ 0,	26,	__ntn_check2,		NTNET_CHK },		/* : ＮＴ－ＮＥＴチェック	*/
// GM849100(E) 名鉄協商コールセンター対応（NT-NET端末間通信）（FT-4000N：MH364304流用）
...
// GM849100(S) 名鉄協商コールセンター対応（NT-NET端末間通信）（設定パラメータマスク解除）
//	{400001,400100},
	{400005,400040},{400042, 400100},
// GM849100(E) 名鉄協商コールセンター対応（NT-NET端末間通信）（設定パラメータマスク解除）
