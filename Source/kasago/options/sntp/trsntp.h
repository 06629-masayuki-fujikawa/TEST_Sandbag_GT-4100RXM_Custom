 ...
 * This file is intended for the user to include in their SNTP applications.
...
int tfKernelSetSystemTimeMsec(
        ttUser32BitPtr  secondsPtr,
        ttUser32BitPtr  msecPtr,
        void *          voidPtr,
        int             size);

int tfKernelGetSystemTimeMsec(
        ttUser32BitPtr  daysPtr,
        ttUser32BitPtr  secondsPtr,
        ttUser32BitPtr  msecPtr);

#define tm_64bit_add(a, b, c, d)      \
{                                     \
    b += d;                           \
    a += c;                           \
    if (b < d)                        \
