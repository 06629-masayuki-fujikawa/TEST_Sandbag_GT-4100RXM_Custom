 ...
 * All rights reserved.
 *
 * $Source: include/trquicc.h $
 *
 * Modification History
 * $Revision: 6.0.2.2 $
 * $Date: 2010/01/18 21:33:41JST $
 * $Author: odile $
 ...
 * Modification History
 * Date: $Date: 2010/01/18 21:33:41JST $
 * Author:
...
/* 24.576 MHz */
#define TM_PROC_CLOCK_RATE 24576000UL
#define TM_QUICC_BAUD_RATE 19200
...
#define TM_QUICC_ETHER_MAX_XMIT_BUFD    (unsigned short)50

#define TM_QUICC_SERIAL_MAX_RECV_BUFD    (unsigned short)5      
#define TM_QUICC_SERIAL_MAX_XMIT_BUFD    (unsigned short)5

/*
 * IOCTL Defines
 */
#define TM_QUICC_REFILL_SCC1   (int)0x0001
#define TM_QUICC_REFILL_SCC4   (int)0x0001
...
int tfQuiccEtherReceive(ttUserInterface   interfaceHandle,
                        char TM_FAR    ** dataPtrPtr,
                        int  TM_FAR     * lengthPtr,
                        ttUserBufferPtr   userBufferHandlePtr);

int tfQuiccEtherSend(ttUserInterface  interfaceHandle,
                     char TM_FAR    * bufferPtr,
                     int              len,
                     int              flag);
int  tfQuiccEtherClose(ttUserInterface interfaceHandle);
int  tfQuiccEtherOpen(ttUserInterface interfaceHandle);
int  tfQuiccSerialClose(ttUserInterface interfaceHandle);
int  tfQuiccSerialOpen(ttUserInterface interfaceHandle);
int  tfQuiccSerialIoctl (ttUserInterface interfaceHandle, int flag,
                         void TM_FAR * optionPtr, int optionLen);
int tfQuiccSerialReceive(ttUserInterface   interfaceHandle,
                         char TM_FAR    ** dataPtrPtr,
                         int  TM_FAR     * lengthPtr,
                         ttUserBufferPtr   userBufferHandlePtr);

int tfQuiccSerialSend(ttUserInterface  interfaceHandle,
                      char TM_FAR    * bufferPtr,
                      int              length,
                      int              flag);

void tfQuiccScc1HandlerIsr(void);    
void tfQuiccScc4HandlerIsr(void);
...
#define TM_QUICC_BRGC_RST      0x00010000UL
#define TM_QUICC_BRGC_DIV16    0x00000001UL
/*
...
#define TM_QUICC_SCC4_RECV_BASE \
            TM_QUICC_SCC1_XMIT_BASE + \
            (TM_QUICC_ETHER_MAX_XMIT_BUFD * sizeof(struct tsQuiccBufDesc) )

#define TM_QUICC_SCC4_XMIT_BASE \
            TM_QUICC_SCC4_RECV_BASE + \
            (TM_QUICC_SERIAL_MAX_RECV_BUFD * sizeof(struct tsQuiccBufDesc) )


/* Receive normal operation */ 
#define TM_QUICC_SCC1_RECV_FUNC_CODE    (unsigned short)0x18    
#define TM_QUICC_SCC4_RECV_FUNC_CODE    (unsigned short)0x15    
/* Transmit normal operation */ 
#define TM_QUICC_SCC1_XMIT_FUNC_CODE    (unsigned short)0x18 
#define TM_QUICC_SCC4_XMIT_FUNC_CODE    (unsigned short)0x15 
/* Max ethernet frame length (Divisable by 4)*/ 
#define TM_QUICC_SCC1_MAX_RECV_BUF_LEN  (unsigned short)1520

/* Maximum UART recieve buffer length */
#define TM_QUICC_SCC4_MAX_RECV_BUF_LEN  (unsigned short)1520
#define TM_QUICC_SCC4_MAX_IDL16         (unsigned short)0x10
#define TM_QUICC_SCC4_BREAK_COUNT       (unsigned short)3
 ...
 * Port B Registers
 */
#define TM_QUICC_PORTB_PB0  (unsigned long)0x00000001UL
#define TM_QUICC_PORTB_PB1  (unsigned long)0x00000002UL
#define TM_QUICC_PORTB_PB2  (unsigned long)0x00000004UL
#define TM_QUICC_PORTB_PB3  (unsigned long)0x00000008UL
#define TM_QUICC_PORTB_PB4  (unsigned long)0x00000010UL
#define TM_QUICC_PORTB_PB5  (unsigned long)0x00000020UL
#define TM_QUICC_PORTB_PB6  (unsigned long)0x00000040UL
#define TM_QUICC_PORTB_PB7  (unsigned long)0x00000080UL
#define TM_QUICC_PORTB_PB8  (unsigned long)0x00000100UL
#define TM_QUICC_PORTB_PB9  (unsigned long)0x00000200UL
#define TM_QUICC_PORTB_PB10 (unsigned long)0x00000400UL
#define TM_QUICC_PORTB_PB11 (unsigned long)0x00000800UL
#define TM_QUICC_PORTB_PB12 (unsigned long)0x00001000UL
#define TM_QUICC_PORTB_PB13 (unsigned long)0x00002000UL
#define TM_QUICC_PORTB_PB14 (unsigned long)0x00004000UL
#define TM_QUICC_PORTB_PB15 (unsigned long)0x00008000UL
#define TM_QUICC_PORTB_PB16 (unsigned long)0x00010000UL
#define TM_QUICC_PORTB_PB17 (unsigned long)0x00020000UL
...
/* short frame padding */
#define TM_QUICC_XMIT_PAD       (unsigned short)0x4000
...
#define TM_QUICC_XMIT_CRC       (unsigned short)0x0400
...
/* defer indication */
#define TM_QUICC_XMIT_E_DEFER       (unsigned short)0x0200
/* heartbeat */
#define TM_QUICC_XMIT_E_HEARTB      (unsigned short)0x0100
/* error: late collision */
#define TM_QUICC_XMIT_E_LATEC       (unsigned short)0x0080
/* error: retransmission limit */
#define TM_QUICC_XMIT_E_LIMIT       (unsigned short)0x0040
/* retry count */
#define TM_QUICC_XMIT_E_COUNT       (unsigned short)0x003c
/* error: underrun */
#define TM_QUICC_XMIT_E_UNDERRUN    (unsigned short)0x0002
/* carier sense lost */
#define TM_QUICC_XMIT_E_CARRIER     (unsigned short)0x0001

/*
 * Receive Buffer Descriptor Flags
 */
/* buffer empty */
#define TM_QUICC_RECV_EMPTY     (unsigned short)0x8000
/* wrap bit */
#define TM_QUICC_RECV_WRAP      (unsigned short)0x2000
/* interrupt on reception */
#define TM_QUICC_RECV_INTR      (unsigned short)0x1000
/* last BD in frame */
#define TM_QUICC_RECV_LAST      (unsigned short)0x0800
/* first BD in frame */
#define TM_QUICC_RECV_FIRST     (unsigned short)0x0400
...
#define TM_QUICC_RECV_ERROR     (unsigned short)0x00ff
 /* frame too long */
#define TM_QUICC_RECV_E_TOOLONG (unsigned short)0x0020
  /* non-octet aligned */
#define TM_QUICC_RECV_E_NOTBYTE (unsigned short)0x0010
/* short frame */
#define TM_QUICC_RECV_E_SHORT   (unsigned short)0x0008
/* receive CRC error */
#define TM_QUICC_RECV_E_CRC     (unsigned short)0x0004
/* receive overrun */
#define TM_QUICC_RECV_E_OVERRUN (unsigned short)0x0002
/* collision */
#define TM_QUICC_RECT_E_COLL    (unsigned short)0x0001
...
#define TM_QUICC_INTR_ETHER_STOP    (unsigned short)0x0080
/* transmit error */
#define TM_QUICC_INTR_ETHER_E_XMIT  (unsigned short)0x0010
/* receive frame */
#define TM_QUICC_INTR_ETHER_RECV_F  (unsigned short)0x0008
/* busy condition */
#define TM_QUICC_INTR_ETHER_BUSY    (unsigned short)0x0004
/* transmit buffer */
#define TM_QUICC_INTR_ETHER_XMIT_B  (unsigned short)0x0002
/* receive buffer */
#define TM_QUICC_INTR_ETHER_RECV_B  (unsigned short)0x0001

/*
 * Serial Interrupts
 */
/* busy condition */
#define TM_QUICC_INTR_SERIAL_BUSY   (unsigned short)0x0004
/* transmit buffer */
#define TM_QUICC_INTR_SERIAL_XMIT_B (unsigned short)0x0002
/* receive buffer */
#define TM_QUICC_INTR_SERIAL_RECV_B (unsigned short)0x0001
...
#define TM_QUICC_ETHER_IND_ADDR      (unsigned short)0x1000
 /* Enable CRC */
#define TM_QUICC_ETHER_ENABLE_CRC    (unsigned short)0x0800
/* Loop Back Mode */
#define TM_QUICC_ETHER_LOOPBACK      (unsigned short)0x0040
/* # of ignored bits 22 */
#define TM_QUICC_ETHER_NBITS_IGNORED (unsigned short)0x000a
/* promiscuous */
#define TM_QUICC_ETHER_PROMISCUOUS   (unsigned short)0x0200
/* broadcast address */
#define TM_QUICC_ETHER_BROADCAST     (unsigned short)0x0100


/* Uart Mode Register */
#define TM_QUICC_UART_FLOW           (unsigned short)0x8000
#define TM_QUICC_STOP_2              (unsigned short)0x4000
#define TM_QUICC_CHAR_6              (unsigned short)0x1000
#define TM_QUICC_CHAR_7              (unsigned short)0x2000
#define TM_QUICC_CHAR_8              (unsigned short)0x3000
...
#define TM_QUICC_UART_XMIT_SAMPLE  0x00020000UL 
#define TM_QUICC_UART_RECV_SAMPLE  0x00008000UL 
...
#define TM_QUICC_UART_RECV_FIFO_1  0x00000020UL
 ...
 * UART defines 
 */
#define TM_QUICC_UART_REJECT_CHAR 0x4000
#define TM_QUICC_UART_LAST_CHAR   0x8000
...
/* MEMC */
    ...
    volatile unsigned long  memc_br4;       /* base register 4 */
    volatile unsigned long  memc_or4;       /* option register 4 */
    volatile unsigned char  RESERVED16[0x8];        /* Reserved area */
    volatile unsigned long  memc_br5;       /* base register 5 */
    volatile unsigned long  memc_or5;       /* option register 5 */
    volatile unsigned char  RESERVED17[0x8];        /* Reserved area */
    volatile unsigned long  memc_br6;       /* base register 6 */
    volatile unsigned long  memc_or6;       /* option register 6 */
    volatile unsigned char  RESERVED18[0x8];        /* Reserved area */
    volatile unsigned long  memc_br7;       /* base register 7 */
    volatile unsigned long  memc_or7;       /* option register 7 */
...
typedef struct tsQuiccControlChars
{
    unsigned char reject;   /* reject the character */
    unsigned char ch;           /* control character */
} ttQuiccControlChars;

#define TM_QUICC_NUM_CONTROL_CHARS 0

/*
ttQuiccControlChars tlQuiccControlChars[] = 
{
    {0,0},
    {0,0},
    {0,0},
