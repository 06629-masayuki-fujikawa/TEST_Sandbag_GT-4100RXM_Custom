...
#define TM_USE_MD5
#endif /* TM_USE_MD5 */
#ifdef TM_MIP_USE_DHCP
#ifndef TM_USE_DHCP
#define TM_USE_DHCP
#endif /* !TM_USE_DHCP */
#endif /* TM_MIP_USE_DHCP */
#endif /* TM_MOBILE_IP4 */
...
#ifdef TM_6_ENABLE_MLDV1
#undef TM_6_ENABLE_MLDV1
#endif /* TM_6_ENABLE_MLDV1 */

#ifdef TM_6_USE_RFC3484
#undef TM_6_USE_RFC3484
...
#ifdef TM_DSP
/* user cannot #define both 16-bit and 32-bit DSP macros */
#if (defined(TM_32BIT_DSP) && defined(TM_16BIT_DSP))
#error "You cannot #define both TM_32BIT_DSP and TM_16BIT_DSP!"
#endif
#endif /* TM_DSP */
...
#if (defined(TM_6_USE_MIP_MN) && !(defined(TM_6_USE_PREFIX_DISCOVERY)))
/*
 * Verify that when TM_6_USE_MIP_MN is #define'd, TM_6_USE_PREFIX_DISCOVERY
 * is also define'd.
 */
#error "If you #define TM_6_USE_MIP_MN, then you must also #define TM_6_USE_PREFIX_DISCOVERY!"
#endif /* TM_6_USE_MIP_MN && ! TM_6_USE_PREFIX_DISCOVERY */

#if defined(TM_USE_IKEV1) || defined(TM_USE_IKEV2)
#define TM_USE_IKE
#else  /* defined(TM_USE_IKEV1) || defined(TM_USE_IKEV2) */
#undef TM_USE_IKE
#endif /* defined(TM_USE_IKEV1) || defined(TM_USE_IKEV2) */

#if (defined(TM_USE_IPSEC_TASK) && !(defined(TM_USE_IPSEC)))
#error "You cannot use the IPsec task without using IPsec!"
#endif /* (defined(TM_USE_IPSEC_TASK) && !(defined(TM_USE_IPSEC))) */

#if (defined(TM_USE_IPSEC_HANDOFF_TASK) && !(defined(TM_USE_IPSEC_TASK)))
#error "You cannot use the IPsec handoff task without using the IPsec task!"
#endif /* (defined(TM_USE_IPSEC_HANDOFF_TASK) && !(defined(TM_USE_IPSEC_TASK))) */
...
#if (!defined(TM_6_USE_DHCP) && defined(TM_6_DHCP_USE_FQDN))
#error "Cannot define TM_6_DHCP_USE_FQDN without defining TM_6_USE_DHCP!"
#endif /* (!defined(TM_6_USE_DHCP) && defined(TM_6_DHCP_USE_FQDN)) */

#if (!defined(TM_6_USE_DHCP) && defined(TM_6_DHCP_USE_AUTH))
#error "Cannot define TM_6_DHCP_USE_AUTH without defining TM_6_USE_DHCP!"
#endif /* (!defined(TM_6_USE_DHCP) && defined(TM_6_DHCP_USE_AUTH)) */

#ifdef TM_USE_UPNP_DEVICE
#ifdef TM_DISABLE_TCP
#error If you #define TM_USE_UPNP_DEVICE, then you must not #define TM_DISABLE_TCP!
#endif /* !TM_DISABLE_TCP */
#ifndef TM_USE_HTTPD
#error If you #define TM_USE_UPNP_DEVICE, then you must also #define TM_USE_HTTPD!
#endif /* ! TM_USE_HTTPD */
#ifndef TM_USE_HTTPD_SSI
#error If you #define TM_USE_UPNP_DEVICE, then you must also #define TM_USE_HTTPD_SSI!
#endif /* ! TM_USE_HTTPD_SSI */
#endif /* TM_USE_UPNP_DEVICE */

#ifdef TM_USE_SOAP
#ifndef TM_USE_HTTPD
#error If you #define TM_USE_SOAP, then you must also #define TM_USE_HTTPD!
#endif /* ! TM_USE_HTTPD */
#endif /* TM_USE_SOAP */

#ifdef TM_USE_SOAP
#ifndef TM_USE_HTTPC
#error If you #define TM_USE_SOAP, then you must also #define TM_USE_HTTPC!
#endif /* ! TM_USE_HTTPC */
#endif /* TM_USE_SOAP */
...
#define tm_snmp_time_ticks(x) (x)/10
 ...
 */
#define TM_SNMPD_CACHES_PER_INET  5
...
/* Index of SNMP prefixes cache in tvSnmpdCaches[] */
#define TM_SNMPC_PREFIX_INDEX     4
...
/* Check if IPsec task POST event is needed */
#define TM_IPSEC_TASK_PEND_POST_NEEDED
#endif /* TM_USE_IPSEC_TASK */
#ifdef TM_USE_IPSEC_HANDOFF_TASK
/* Check if IPsec task POST event is needed */
#define TM_IPSEC_HANDOFF_TASK_PEND_POST_NEEDED
#endif /* TM_USE_IPSEC_HANDOFF_TASK */
#endif /* TM_PEND_POST_NEEDED */

#ifdef TM_PEND_POST_NEEDED
#ifdef TM_USE_IP_REASSEMBLY_TASK
/* Check if IP Reassembly task POST event is needed */
#define TM_IP_REASSEMBLY_TASK_PEND_POST_NEEDED
...
#ifdef TM_IPSEC_TASK_PEND_POST_NEEDED
#define tm_kernel_create_ipsec_task_event(x)   tfKernelCreateEvent(x)
#define tm_kernel_post_ipsec_task_event(x)     tfKernelTaskPostEvent(x)
#else /* !TM_IPSEC_TASK_PEND_POST_NEEDED */
#define tm_kernel_create_ipsec_task_event(x)
#define tm_kernel_post_ipsec_task_event(x)
#endif /* TM_IPSEC_TASK_PEND_POST_NEEDED */

#ifdef TM_IPSEC_HANDOFF_TASK_PEND_POST_NEEDED
#define tm_kernel_create_ipsec_handoff_task_event(x)   tfKernelCreateEvent(x)
#define tm_kernel_post_ipsec_handoff_task_event(x)     tfKernelTaskPostEvent(x)
#else /* !TM_IPSEC_TASK_PEND_POST_NEEDED */
#define tm_kernel_create_ipsec_handoff_task_event(x)
#define tm_kernel_post_ipsec_handoff_task_event(x)
#endif /* TM_IPSEC_TASK_PEND_POST_NEEDED */

#ifdef TM_IP_REASSEMBLY_TASK_PEND_POST_NEEDED
#define tm_kernel_create_ip_reassembly_task_event(x) tfKernelCreateEvent(x)
#define tm_kernel_post_ip_reassembly_task_event(x)   tfKernelTaskPostEvent(x)
#else /* !TM_IP_REASSEMBLY_TASK_PEND_POST_NEEDED */
#define tm_kernel_create_ip_reassembly_task_event(x)
#define tm_kernel_post_ip_reassembly_task_event(x)
#endif /* TM_IP_REASSEMBLY_TASK_PEND_POST_NEEDED */
...
#define tm_strcmp(a, b)              strcmp( (ttConstCharPtr)(a), \
                                             (ttConstCharPtr)(b))
#define tm_stricmp(a, b)             stricmp( (ttConstCharPtr)(a), \
                                              (ttConstCharPtr)(b))
...
{                                                  \
    (LLL).uu96low += (tt32Bit)((LL).uu64low);      \
    if ((LLL).uu96low < (tt32Bit)((LL).uu64low))   \
    {                                              \
        (LLL).uu96mid ++;                          \
    }                                              \
    (LLL).uu96mid += (tt32Bit) ((LL).uu64high);    \
    if ((LLL).uu96mid <= (tt32Bit)((LL).uu64high)) \
    {                                              \
        (LLL).uu96high ++;                         \
    }                                              \
}                                     
...
#define tm_96Bit_augm64(LLL, LL) (LLL).u96low += (tt32Bit)((LL).u64low);      \
                                 if ((LLL).u96low < (tt32Bit)((LL).u64low))   \
                                 {                                            \
                                     (LLL).u96mid ++;                         \
                                 }                                            \
                                 (LLL).u96mid += (tt32Bit) ((LL).u64high);    \
                                 if ((LLL).u96mid <= (tt32Bit)((LL).u64high)) \
                                 {                                            \
                                     (LLL).u96high ++;                        \
                                 }                                     
...
#define tm_s96Bit_augm64(LLL, LL) (LLL).s96low += (tt32Bit)((LL).s64low);      \
                                  if ((LLL).s96low < (tt32Bit)((LL).s64low))   \
                                  {                                            \
                                      (LLL).s96mid ++;                         \
                                  }                                            \
                                  (LLL).s96mid += (tt32Bit) ((LL).s64high);    \
                                  if ((LLL).s96mid <= (tt32Bit)((LL).s64high)) \
                                  {                                            \
                                      (LLL).s96high ++;                        \
                                  }                                     
...
#ifdef TM_USE_UPNP_DEVICE
/* UPPSWR90112 */
#define TM_IP_DEF_MULTICAST_TTL    4
#else /* ! TM_USE_UPNP_DEVICE */
...
#ifdef TM_BYPASS_ETHER_LL
/* TM_BYPASS_ETHER_LL not currently supported with 802.3 link-layer */
#undef TM_BYPASS_ETHER_LL
#endif /* TM_BYPASS_ETHER_LL */
#endif /* TM_USE_ETHER_8023_LL */

#if defined(TM_USE_ETHER_8023_LL) || defined(TM_USE_PPPOE)
 ...
 */
#define TM_PAK_LL_MAX_HDR_LEN              24
#else /* TM_PAK_LL_MAX_HDR_LEN */
#if TM_PAK_LL_MAX_HDR_LEN < 22
#define TM_PAK_LL_MAX_HDR_LEN              22
#endif /* TM_PAK_LL_MAX_HDR_LEN < 22 */
#endif /* TM_PAK_LL_MAX_HDR_LEN */
#endif /* TM_USE_ETHER_8023_LL || TM_USE_PPPOE */
...
/* Default recv queue size in bytes, should be 2^14 + 2048 + 4 */
#define TM_SOC_RECV_Q_BYTES  18436
...
#undef TM_USE_SSL_CLIENT
#endif /* TM_USE_SSL_CLIENT */

#ifdef TM_USE_SSL_SERVER
#undef TM_USE_SSL_SERVER
...
#define TM_ROUND_MASK_SIZE          ~(unsigned)(TM_ROUND_SIZE)
...
#ifdef TM_6_USE_MIP_CN
#ifdef TM_6_USE_MIP_MN
/* CN and MN route optimization */
#define TM_6_MIP_MAX_HDR_LEN \
        (TM_6_IP_MIN_HDR_LEN + TM_6_TYPE_2_ROUTING_HDR_LEN)
#else /* ! TM_6_USE_MIP_MN */
/* CN only (route optimization) */
#define TM_6_MIP_MAX_HDR_LEN        TM_6_TYPE_2_ROUTING_HDR_LEN
#endif /* ! TM_6_USE_MIP_MN */
#else /* ! TM_6_USE_MIP_CN */
#ifdef TM_6_USE_MIP_MN
/* MN only (tunnel through home agent) */
#define TM_6_MIP_MAX_HDR_LEN        TM_6_IP_MIN_HDR_LEN
#else /* ! TM_6_USE_MIP_MN */
#define TM_6_MIP_MAX_HDR_LEN        0
#endif /* ! TM_6_USE_MIP_MN */
#endif /* ! TM_6_USE_MIP_CN */
#else /* ! TM_6_USE_MIP_RO */
...
#else /* TM_USE_TCP */
/* Number of recycled lists */
#define TM_RECY_NUM                     (TM_RECY_SOCKET + 1)
#endif /* TM_USE_TCP */
...
#else /* !TM_USE_SSL_CLIENT && !TM_USE_SSL_SERVER */
#define tm_tcp_soc_recv_left(socketPtr, tcpVectPtr) \
   tm_soc_recv_left(socketPtr)
...
#if (defined(TM_USE_IPSEC) || defined(TM_USE_SSL_CLIENT) || \
    defined(TM_USE_SSL_SERVER))
#if (defined(TM_IPSEC_DEBUG) || defined(TM_IKE_DEBUG) || \
    defined(TM_SSL_DEBUG) || defined(TM_IPCOMP_DEBUG))
#ifndef TM_DEBUG_LOGGING
#define TM_DEBUG_LOGGING
#endif /* TM_DEBUG_LOGGING */
#endif /* defined(TM_IPSEC_DEBUG) || defined(TM_IKE_DEBUG)*/
#endif /* TM_USE_IPSEC || TM_USE_SSL  */
...
/* Check that a time has been removed */
#define tm_timer_removed(timerPtr) \
 ...
 * This is to check whether a timer has been reinitialized removed or suspended
...
/* Flags to be set per multi home */
/* DO NOT CHANGE THIS MACRO DEFINITION!!! */
#define TM_DEV_IP_CONF_FLAGS                                            \
 (TM_DEV_IP_CONFIG | TM_DEV_IP_CONF_STARTED | TM_DEV_IP_USER_CONF_FLAGS )
...
#define tm_8bit_set_bit(byte, bit)   (byte) |= (tt8Bit)(bit)
#define tm_8bit_clr_bit(byte, bit)   \
                    (byte) = (byte) & ~(tt8Bit)(bit)
...
#define tm_16bit_set_bit(shorts16, bit) \
                                    (shorts16) |= (tt16Bit)(bit)
#define tm_16bit_clr_bit(shorts16, bit) \
                (shorts16) = (shorts16) & ~(tt16Bit)(bit)
...
#define tm_ip_set_vers_Len(hdrLen) (tt8Bit)((tt8Bit)(TM_IP_4<<4) \
                                    |(tt8Bit)((tt8Bit)(hdrLen)))
#endif /* TM_32BIT_DSP */
#ifdef TM_16BIT_DSP
#define tm_ip_set_vers_Len(hdrLen) (tt8Bit)((tt8Bit)(TM_IP_4<<4) \
                                    |(tt8Bit)(((tt8Bit)(hdrLen))>>1))
#endif /* TM_16BIT_DSP */
#else /* !TM_DSP */
#define tm_ip_set_vers_Len(hdrLen) (tt8Bit)((tt8Bit)(TM_IP_4<<4) \
...
/*
 * Local IP v4 network is 169.254/16
 * Local IPv4 addresses between 169.254.1.0, and 169.254.254.255 can
 * be selected.
 * (169.254.0/8, and 169.254.255/8 are reserved for future use.)
 */
#define TM_IP_LOCAL_NET           tm_const_htonl(TM_UL(0xA9FE0000))
#define TM_IP_LOCAL_FIRST         tm_const_htonl(TM_UL(0xA9FE0100))
#define TM_IP_LOCAL_LAST          tm_const_htonl(TM_UL(0xA9FEFEFF))
/* Smallest value (in host byte order) to give to lower part of the address) */
#define TM_IP_LOCAL_SMALLEST_HOST 0x0100
/* Biggest value (in host byte order) to give to lower part of the address) */
#define TM_IP_LOCAL_BIGGEST_HOST  0xFEFE
#define tm_ip_is_local(ipAddr) \
      tm_ip_match(tm_ip_net(ipAddr, TM_IP_CLASS_B_NET_MASK), TM_IP_LOCAL_NET)
...
/* Host route because of duplicate local routes */
#define TM_RTE2_LOCAL_DUPLICATE (tt16Bit)0x0080

#ifdef TM_USE_ETHER_8023_LL
/* 802.3 flags stored in routing entry rte8023Flags */
#define TM_RTE8023_ETH_RESPONSE (tt8Bit)0x0010 /* Ethernet Response Received */
#define TM_RTE8023_ETH_8023     (tt8Bit)0x0020 /* Ethernet Type is 802.3 */
#define TM_RTE8023_ETH_FIRST    (tt8Bit)0x0040 /* First Packet has been sent */
#endif /* TM_USE_ETHER_8023_LL */
...
#ifdef TM_SA_PMTU
/* PMTU aging period (in seconds) */
#ifndef TM_SA_PMTU_AGING_PERIOD
#define TM_SA_PMTU_AGING_PERIOD 600
#endif /* TM_SA_PMTU_AGING_PERIOD */
#endif /* TM_SA_PMTU */
 ...
 */
#ifdef TM_USE_PPPOE
/* Room for Ethernet header + PPPoE + PPP protocol */
#define TM_PPP_ALLOC_HDR_BYTES  (TM_ETHER_HEADER_SIZE + 8)
#else /* !TM_USE_PPPOE */
...
#ifdef TM_DSP
#define TM_VJ_COMP_SIZE      0  /* VJ compression not supported on DSPs */
#else /* !TM_DSP */
...
#define tm_tcp_get_option(opt, optPtr, index, bytePos) \
    opt = ((*(optPtr)) >> ((bytePos)-- << 3)) & 0xff; \
    if (bytePos < 0) \
    { \
        bytePos = (TM_DSP_BYTES_PER_WORD - 1); \
        (optPtr)++; \
    }        
...
{                                                                      \
    ...
    for (i = 24; i > 0; i-=8)                                          \
    {                                                                  \
        tm_tcp_get_option(optionVal, srcPtr, 0, bytePos);              \
        dest |= optionVal << i;                                        \
    }                                                                  \
}
#else /* !TM_DSP */
...
#ifdef TM_USE_TCP_REXMIT_CONTROL
/* paused rexmit timer */
#define TM_TCPF3_REXMIT_PAUSE        (tt16Bit)0x0004
#define TM_TCPF3_REXMIT_RESET        (tt16Bit)0x0008
#endif /* TM_USE_TCP_REXMIT_CONTROL */
...
#ifdef TM_USE_IKE
#define TM_ISAKMP_STATE_NULL_PTR     (ttIsakmpStatePtr)0
#define TM_IKE_GLOBAL_NULL_PTR       (ttIkeGlobalPtr)0
#endif /* TM_USE_IKE */
#define TM_IKE_ENTRY_NULL_PTR        (ttIkeEntryPtr)0
#ifdef TM_USE_IPSEC
#define TM_IPSEC_ENTRY_NULL_PTR      (ttIpsecEntryPtr)0
#define TM_SADBRECORD_NULL_PTR       (ttSadbRecordPtr)0
#define TM_SADBSA_NULL_PTR           (sadb_sa TM_FAR *)0
#define TM_SADBHANDLE_NULL_PTR       (ttSadbHandlePtr)0
#define TM_POLICY_NULL_PTR           (ttPolicyEntryPtr)0
#define TM_PADB_NULL_PTR             (ttPadbEntryPtr)0
#endif /* TM_USE_IPSEC */
...
#define TM_IGMP_V3                  3
#ifdef TM_USE_IGMPV3
#define TM_IGMP_MAX_VERSION         TM_IGMP_V3 
#else /* !TM_USE_IGMPV3 */
...
#define TM_LOG_MODULE_IKEV2         3  /* IKEv2 module */
#define TM_LOG_MODULE_IPSEC         4  /* IPsec module */
#define TM_LOG_MODULE_SECURITY      5  /* Generic security module */
#define TM_LOG_MODULE_CRYPTO        6  /* Crypto module */
#define TM_LOG_MODULE_CERT          7  /* Certificate module */
#define TM_LOG_MODULE_IKE_STATS     8  /* IKE stats module */
#define TM_LOG_MODULE_IPSEC_STATS   9  /* IPsec Stats module */
#define TM_LOG_MODULE_IPSEC_POLICY  10  /* IPsec Policy module */
#define TM_LOG_MODULE_PRIORITIES    11 /* IKE/IPsec Priorities module */
#define TM_LOG_MODULE_MSGSPI        12 /* Message SPI module */
#define TM_LOG_MODULE_SSL           13 /* SSL module */
#define TM_LOG_MODULE_IPV4          14 /* IPv4 module */
#define TM_LOG_MODULE_IPV6          15 /* IPv6 module */
#define TM_LOG_MODULE_MAX           15 /* Equal to largest log module */
...
#define TM_LOG_ENB_MODULE_IKEV2
...
#define TM_LOG_ENB_MODULE_IPV4
#define TM_LOG_ENB_MODULE_IPV6
...
#ifdef TM_LOG_ENB_MODULE_IKEV2
#ifdef TM_LOG_ENB_LEVEL_ERROR
#define TM_LOG_IKEV2_ERROR
#endif /* TM_LOG_ENB_LEVEL_ERROR */
#ifdef TM_LOG_ENB_LEVEL_WARNING
#define TM_LOG_IKEV2_WARNING
#endif /* TM_LOG_ENB_LEVEL_WARNING */
#ifdef TM_LOG_ENB_LEVEL_NOTICE
#define TM_LOG_IKEV2_NOTICE
#endif /* TM_LOG_ENB_LEVEL_NOTICE */
#ifdef TM_LOG_ENB_LEVEL_INFO
#define TM_LOG_IKEV2_INFO
#endif /* TM_LOG_ENB_LEVEL_INFO */
#ifdef TM_LOG_ENB_LEVEL_DEBUG
#define TM_LOG_IKEV2_DEBUG
#endif /* TM_LOG_ENB_LEVEL_DEBUG */
#endif /* TM_LOG_ENB_MODULE_IKEV2 */
...
#ifdef TM_LOG_ENB_MODULE_IPV4
#ifdef TM_LOG_ENB_LEVEL_ERROR
#define TM_LOG_IPV4_ERROR
#endif /* TM_LOG_ENB_LEVEL_ERROR */
#ifdef TM_LOG_ENB_LEVEL_WARNING
#define TM_LOG_IPV4_WARNING
#endif /* TM_LOG_ENB_LEVEL_WARNING */
#ifdef TM_LOG_ENB_LEVEL_NOTICE
#define TM_LOG_IPV4_NOTICE
#endif /* TM_LOG_ENB_LEVEL_NOTICE */
#ifdef TM_LOG_ENB_LEVEL_INFO
#define TM_LOG_IPV4_INFO
#endif /* TM_LOG_ENB_LEVEL_INFO */
#ifdef TM_LOG_ENB_LEVEL_DEBUG
#define TM_LOG_IPV4_DEBUG
#endif /* TM_LOG_ENB_LEVEL_DEBUG */
#endif /* TM_LOG_ENB_MODULE_IPV4 */

#ifdef TM_LOG_ENB_MODULE_IPV6
#ifdef TM_LOG_ENB_LEVEL_ERROR
#define TM_LOG_IPV6_ERROR
#endif /* TM_LOG_ENB_LEVEL_ERROR */
#ifdef TM_LOG_ENB_LEVEL_WARNING
#define TM_LOG_IPV6_WARNING
#endif /* TM_LOG_ENB_LEVEL_WARNING */
#ifdef TM_LOG_ENB_LEVEL_NOTICE
#define TM_LOG_IPV6_NOTICE
#endif /* TM_LOG_ENB_LEVEL_NOTICE */
#ifdef TM_LOG_ENB_LEVEL_INFO
#define TM_LOG_IPV6_INFO
#endif /* TM_LOG_ENB_LEVEL_INFO */
#ifdef TM_LOG_ENB_LEVEL_DEBUG
#define TM_LOG_IPV6_DEBUG
#endif /* TM_LOG_ENB_LEVEL_DEBUG */
#endif /* TM_LOG_ENB_MODULE_IPV6 */
...
#define tm_tupleptr_cmp(xPtr1, xPtr2) \
        tm_memcmp(xPtr1, xPtr2, sizeof(*xPtr1))
#endif /* !tm_tupleptr_cmp */

#ifndef tm_tuple_cmp
/* Compare 2 ttSockTuple structures */
#define tm_tuple_cmp(x1, x2) \
        tm_memcmp(&x1, &x2, sizeof(x1))
#endif /* !tm_tupleptr_cmp */
...
#ifdef TM_USE_IPV4
#ifdef TM_USE_IPSEC
/* dual IP layer w/ IPsec: one IPv4 tunnel header for IPv6 automatic/configured
   tunneling (20 bytes), base IPv6 header (40 bytes), one IPv6 tunnel header
   (40 bytes), plus 2 AH extension headers (2 * 24 = 48 bytes). */
#define TM_IP_DEF_MAX_HDR_LEN \
    (TM_4_IP_MIN_HDR_LEN + (2 * TM_6_IP_MIN_HDR_LEN) \
        + (2 * TM_MAX_AH_HDR_LEN) + TM_6_MIP_MAX_HDR_LEN)
#else /* ! TM_USE_IPSEC */
...
#else /* ! TM_USE_IPV4 */
#ifdef TM_USE_IPSEC
/* IPv6-only mode w/ IPsec: base IPv6 header, one IPv6 tunnel header,
   plus 2 AH extension headers */
#define TM_IP_DEF_MAX_HDR_LEN \
    ((2 * TM_6_IP_MIN_HDR_LEN) + (2 * TM_MAX_AH_HDR_LEN) \
        + TM_6_MIP_MAX_HDR_LEN)
#else /* ! TM_USE_IPSEC */
...
#else /* ! TM_USE_IPV6 */
#ifdef TM_USE_IPSEC
/* IPv4-only w/ IPsec: base IPv4 header, one IPv4 tunnel header, plus 2 AH
   extension headers */
#define TM_IP_DEF_MAX_HDR_LEN \
    ((2 * TM_4_IP_MIN_HDR_LEN) + (2 * TM_MAX_AH_HDR_LEN))
#else /* ! TM_USE_IPSEC */
 ...
 */
#ifdef TM_USE_IPSEC
/* w/ IPsec: two nested ESP trailers, each ESP payload padded to a 16-byte
   address boundary (17 + 4 = 21) plus 12 bytes of authentication data
   (2 * 12 = 24). */
#define TM_IP_DEF_MAX_TRAILER_LEN \
      ((2 * TM_IPSEC_MAX_BLOCK_SIZE) + (2 * TM_ESP_AH_TRAILER_SIZE))
#else /* ! TM_USE_IPSEC */
...
#ifdef TM_USE_IGMPV3
/* Do not check for router alert option on IGMPv2 queries */
#define TM_DEVF2_NO_IGMPV2_RA           0x0040
#endif /* TM_USE_IGMPV3 */
...
#define TM_DEVF2_UNINITIALIZING         0x0100

#ifdef TM_USE_IPV6
/*
 * Disable IPv6 site-local and global address auto configuration
 */
#define TM_6_DEVF2_NO_AUTOCONFIG        0x0200

#ifdef TM_6_USE_FILTERING
#define TM_6_DEVF2_FILTERING            0x0400
 ...
 * some other node.
 */
#define TM_6_DEVF2_NO_DEST_UNREACH      0x0800
#endif /* TM_USE_IPV6 */

#ifdef TM_USE_IGMP_FILTERING
#define TM_DEVF2_IGMP_FILTERING         0x1000
#endif /* TM_USE_IGMP_FILTERING */

#define TM_DEVF2_DISABLE_ICMP_RTR_ADVERT    0x2000
...
#define TM_USE_PPPOE_CLIENT_SERVER /* client and server */
...
#ifdef TM_USE_IPSEC_TASK
#ifdef TM_USE_IPV4
#define TM_IPSEC_TASK_SRC_IP_TX          0x0001
#define TM_IPSEC_TASK_SRC_IP_RX          0x0002
#endif /* TM_USE_IPV4 */
#ifdef TM_USE_IPV6
#define TM_IPSEC_TASK_SRC_IP6_TX         0x0003
#define TM_IPSEC_TASK_SRC_IP6_RX         0x0004
#endif /* TM_USE_IPV6 */
#ifdef TM_USE_IPSEC_HANDOFF_TASK
#define TM_IPSEC_HANDOFF_TASK_SRC_AH_RX  0x0005
#define TM_IPSEC_HANDOFF_TASK_SRC_ESP_RX 0x0006
#endif /* TM_USE_IPSEC_HANDOFF_TASK */
#endif /* TM_USE_IPSEC_TASK */

#ifdef TM_USE_IKEV2_EAP_MSCHAPV2
#ifndef TM_USE_MD4
#define TM_USE_MD4
#endif /* TM_USE_MD4 */
#endif /* TM_USE_IKEV2_EAP_MSCHAPV2 */

#if (defined(TM_USE_ASYNC_CRYPTO) && !(defined(TM_PEND_POST_NEEDED)))
#error "Async crypto can only be used in blocking environments!"
#endif /* (defined(TM_USE_ASYNC_CRYPTO) && !(defined(TM_PEND_POST_NEEDED))) */
...
#define TM_BSD_FAMILY_INET      0x1 /* Address family is AF_INET/AF_INET6 */
#define TM_BSD_FAMILY_NONINET   0x2 /* Address family is not AF_INET/AF_INET6 */
/* Address family could be any */
#define TM_BSD_FAMILY_ANY  ((TM_BSD_FAMILY_INET) | (TM_BSD_FAMILY_NONINET))
...
#ifdef TM_USE_EAP
/*
 * Extensible Authentication Protocol (EAP) flags:
 */

/* EAP opening flags:  */
#define TM_EAP_PEER_FLAG  1   /* EAP is being opened for peer authentication */
#define TM_EAP_AUTH_FLAG  2   /* EAP is being opened as an authenticator */

/* EAP notification result codes */
#define TM_EAP_AUTH_SUCCESS 0
#define TM_EAP_AUTH_FAILURE 1

/* EAP remote/local flags */
#define TM_EAP_REMOTE 1
#define TM_EAP_LOCAL  2
#endif /* TM_USE_EAP */
...
#define tm_8bit(word) (tt8Bit)((word) & 0xff)

/* Sets a single byte in long (32-bit) word.  Assumes that 'byteOffset' refers
   to this particular word (i.e. <= 3) */
#define tm_dsp_set_byte_long_ptr(longPtr, byteOffset, data) \
    *((tt32BitPtr)longPtr) &= ~(0xff << ((3 - byteOffset) << 3)); \
    *((tt32BitPtr)longPtr) |= (data << ((3 - byteOffset)  << 3))
/* 
...
#ifndef TM_PPPOE_PADI_RETRIES_MAX
/* 
 * Maximum number of times the PPPoE client will retry sending a PADI packet
 * while waiting to receive a PADO packet.
 */
#define TM_PPPOE_PADI_RETRIES_MAX   4
#endif /* !TM_PPPOE_PADI_RETRIES_MAX */

#ifndef TM_PPPOE_PADR_RETRIES_MAX
/*
 * Maximum number of times the PPPoE client will retry sending a PADR packet
 * while waiting to receive a PADS packet.
 */
#define TM_PPPOE_PADR_RETRIES_MAX   4
#endif /* !TM_PPPOE_PADR_RETRIES_MAX */

#ifndef TM_PPPOE_DISC_RETRIES_MAX
/* 
 * Maximum number of times the PPPoE client will retry re-sending a PADI packet
 * after not having received a PADS packet within the maximum number of PADR
 * retries.
 */
#define TM_PPPOE_DISC_RETRIES_MAX   1
#endif /* !TM_PPPOE_DISC_RETRIES_MAX */

#ifndef TM_PPPOE_INITIAL_RETRY_WAIT
/* 
 * Initial waiting period in milli-seconds before re-sending a PADI, or PADR
 * packet
 */
#define TM_PPPOE_INITIAL_RETRY_WAIT     TM_UL(1000)
#endif /*! TM_PPPOE_INITIAL_RETRY_WAIT */

#ifndef TM_PPPOE_DISC_SRVR_TIMEOUT
/* 
 * Server timeout during discovery waiting for next expected packet. Default
 * 10000 ms.
 */
#define TM_PPPOE_DISC_SRVR_TIMEOUT      TM_UL(10000)
#endif /*! TM_PPPOE_DISC_SRVR_TIMEOUT */

/*
 * Maximum option length for user settable service name tag or AC name tag,
 * or host Uniq tag
 */
#define TM_PPPOE_OPT_MAX_NAME_TAG_LEN   255

/* Macros used for PPPoE options arrays sizes in PPPoE Vector */
#define TM_PPPOE_INDEX_32BIT_MAX  (TM_PPPOE_INDEX_32BIT_0 + 1)
#define TM_PPPOE_INDEX_INT_MAX    (TM_PPPOE_INDEX_INT_2 + 1)
#define TM_PPPOE_INDEX_PTR_MAX    (TM_PPPOE_INDEX_PTR_1 + 1)

/*
 * PPPoE ethernet types in network byte order
 */
#ifdef TM_LITTLE_ENDIAN
/* Ethernet type during Discovery phase */
#define TM_PPPOE_DISC_ETH_TYPE      0x6388U
/* Ethernet type during PPP session phase */
#define TM_PPPOE_PPP_ETH_TYPE       0x6488U
#else /* !TM_LITTLE_ENDIAN */
/* Ethernet type during Discovery phase */
#define TM_PPPOE_DISC_ETH_TYPE      0x8863U
/* Ethernet type during PPP session phase */
#define TM_PPPOE_PPP_ETH_TYPE       0x8864U
#endif /* !TM_LITTLE_ENDIAN */
...
/* state bits, see tvUpnpVect.uppsState */
#define TM_UPNP_STATE_CLOSING (tt8Bit) 1

/* Unlock the UPnP state vector, decrement the owner count and free it if its
   owner count has reached 0 */
#ifdef TM_LOCK_NEEDED
#define tm_ckin_upnp_vect(unlockFlag) \
    tfCkinUpnpVect(unlockFlag)
#else /* !TM_LOCK_NEEDED */
#define tm_ckin_upnp_vect(unlockFlag) \
    tfCkinUpnpVect()
#endif /* !TM_LOCK_NEEDED */

/* Default product name/version strings sent in the SERVER HTTP header in SSDP
   advertisements and SOAP and GENA response messages. The user can override
   these macros in their trsystem.h file or at run-time by calling
   tfUpnpUserSetProductInfo. */
#ifndef TM_UPNP_DEF_PRODUCT_NAME
#define TM_UPNP_DEF_PRODUCT_NAME        "product"
#endif /* ! TM_UPNP_DEF_PRODUCT_NAME */
#ifndef TM_UPNP_DEF_PRODUCT_VERSION
#define TM_UPNP_DEF_PRODUCT_VERSION     "1.1"
#endif /* ! TM_UPNP_DEF_PRODUCT_VERSION */

#ifndef TM_SSDP_DEF_CACHE_CTL
/* default value of Treck option TM_OPTION_SSDP_DEFAULT_CACHE_CTL */
#define TM_SSDP_DEF_CACHE_CTL 1800
#endif /* ! TM_SSDP_DEF_CACHE_CTL */
#endif /* TM_USE_UPNP_DEVICE */

#if (defined(TM_USE_UPNP_DEVICE) || defined(TM_USE_SOAP))

#ifndef TM_UPNP_VERSION
#define TM_UPNP_VERSION                 "UPnP/1.0"
#endif /* TM_UPNP_VERSION */

/* SOAP error code passed to tfSoapUserSendError, "Invalid Action".
   No action by that name at this service. */
#define TM_SOAP_ERR_401_INVALID_ACTION  401

/* SOAP error code passed to tfSoapUserSendError, "Invalid Args".
   Could be any of the following: not enough in args, too many in args,
   no in arg by that name, one or more in args are of the wrong data type. */
#define TM_SOAP_ERR_402_INVALID_ARGS    402

/* SOAP error code passed to tfSoapUserSendError, "Invalid Var".
   No state variable by that name at this service (error response to
   QueryStateVariable pre-defined action) */
#define TM_SOAP_ERR_404_INVALID_VAR     404

/* SOAP error code passed to tfSoapUserSendError, "Argument Value Out of
   Range". An argument value is less than the minimum or more than the
   maximum value of the allowedValueRange, or is not in the allowedValueList.*/
#define TM_SOAP_ERR_601_OUT_RANGE       601

#ifndef TM_UPNP_MAX_ACTION_INDEX
#define TM_UPNP_MAX_ACTION_INDEX    30
#endif /* !TM_UPNP_MAX_ACTION_INDEX */
#ifndef TM_UPNP_MAX_STATE_VAR_INDEX
#define TM_UPNP_MAX_STATE_VAR_INDEX 7
#endif /* !TM_UPNP_MAX_STATE_VAR_INDEX */

#endif /* TM_USE_UPNP_DEVICE || TM_USE_SOAP */

#ifdef TM_USE_SOAP
/* This code is used to indicate that no SOAP error occurred */ 
#define TM_SOAP_STATCODE_OK             0

/* SOAP OPTION, Allow M-POST method only */
#define TM_SOAPOPT_MPOSTONLY         0x00000001

/* SOAP message types, passed to tfSoapMsgConstruct */
typedef enum {
/* SOAP control request msg  */
    TM_SOAP_MSGTYPE_ACTION_REQ,
/* SOAP control response msg */
    TM_SOAP_MSGTYPE_ACTION_RESP,
/* SOAP query request msg */
    TM_SOAP_MSGTYPE_QUERY_REQ,
/* SOAP query response msg */
    TM_SOAP_MSGTYPE_QUERY_RESP,
/* SOAP error msg */
    TM_SOAP_MSGTYPE_ERROR
} ttSoapMsgType;
#endif /* TM_USE_SOAP */

#ifdef TM_USE_SSDP
/* Multicast Addresses */
#define TM_4_SSDP_MCAST_ADDR            "239.255.255.250"
#define TM_6_SSDP_MCAST_ADDR            "FF02::C"

/* Multicast Ports */
#define TM_SSDP_MCAST_PORT              1900

/* SSDP Advertisement Addresses and Ports */
#define TM_4_SSDP_ADV_ADDR_PORT         "239.255.255.250:1900"
#define TM_6_SSDP_ADV_ADDR_PORT         "[FF02::C]:1900"

/* SSDP Message Types */
#define TM_SSDP_MSG_TYPE_ANNOUNCE       0
#define TM_SSDP_MSG_TYPE_UNAVAIL        0
#define TM_SSDP_MSG_TYPE_RESPONSE       2 

#ifndef TM_SSDP_NUM_ANNOUNCE_REXMITS
/* Due to the unreliable nature of UDP, devices should send SSDP "ssdp:alive"
   advertisement messages more than once */
#define TM_SSDP_NUM_ANNOUNCE_REXMITS    1
#endif /* ! TM_SSDP_NUM_ANNOUNCE_REXMITS */
#endif /* TM_USE_SSDP */

#ifdef TM_USE_HTTPU
/* HTTPU Message Types */
#define TM_HTTPU_MSG_TYPE_NOTIFY        0  
#define TM_HTTPU_MSG_TYPE_SEARCH        1 
#define TM_HTTPU_MSG_TYPE_RESPONSE      2
#define TM_HTTPU_MSG_TYPE_INVALID       3  

/* HTTPU Header Types */
#define TM_HTTPU_HDR_TYPE_HOST          0
#define TM_HTTPU_HDR_TYPE_CACHE_CONTROL 1
#define TM_HTTPU_HDR_TYPE_LOCATION      2
#define TM_HTTPU_HDR_TYPE_NT            3
#define TM_HTTPU_HDR_TYPE_NTS           4
#define TM_HTTPU_HDR_TYPE_SERVER        5
#define TM_HTTPU_HDR_TYPE_USN           6
#define TM_HTTPU_HDR_TYPE_MAX           7
#define TM_HTTPU_HDR_TYPE_MX            8
#define TM_HTTPU_HDR_TYPE_ST            9
#define TM_HTTPU_HDR_TYPE_DATE          10
#define TM_HTTPU_HDR_TYPE_EXT           11
#define TM_HTTPU_HDR_TYPE_MAN           12
#define TM_HTTPU_MAX_HDR_TYPE           13

/* HTTPU Method Header Types */
#define TM_HTTPU_NOTIFY_HDR_STR         "NOTIFY * HTTP/1.1"
#define TM_HTTPU_SEARCH_HDR_STR         "M-SEARCH * HTTP/1.1"
#define TM_HTTPU_RESPONSE_HDR_STR       "HTTP/1.1 200 OK"

/* HTTP Method Header Lengths */
#define TM_HTTPU_NOTIFY_HDR_LEN         17
#define TM_HTTPU_SEARCH_HDR_LEN         19
#define TM_HTTPU_RESPONSE_HDR_LEN       15
#endif /* TM_USE_HTTPU */
