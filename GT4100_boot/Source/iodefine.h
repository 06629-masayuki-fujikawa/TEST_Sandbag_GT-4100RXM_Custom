...
/* History    : V1.0A (2011-08-04)  [Hardware Manual Revision : 1.00]           */
...
/*| 拡張I/O定義                                                            |*/
/*[]----------------------------------------------------------------------[]*/
// 入出力ポートのアドレスが同じになっているが回路的に信号がデコードされており問題ないようにできています。
#define	EXIO_CS4_EXIO		(*(volatile unsigned short *)0x4000000)	//	拡張I/O	入力:16Port，出力:16Port
#define	CP_OUTREG_EN		PORT6.PODR.BIT.B5						// 出力ポートイネーブル信号 0=有効 1=無効 
